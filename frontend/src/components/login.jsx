...
export default function AuthPage({ onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        // 🔐 LOGIN
        const res = await axios.post("https://dailycode-learning-plateform-4.onrender.com/api/auth/login", {
          email: form.email,
...
if (res.data.role === "admin") {
  ...
  navigate("/");
        ...
        // 📝 SIGNUP
        const res = await axios.post("https://dailycode-learning-plateform-4.onrender.com/api/auth/signup", {
          name: form.name,
          email: form.email,
          password: form.password,
        });
